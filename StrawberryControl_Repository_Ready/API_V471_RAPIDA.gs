/**
 * STRAWBERRY CONTROL V4.7.1 - API NEGOCIO COMPLETO + RENDIMIENTO
 * -----------------------------------------------------------------------------
...
function apiActualizarConfiguracionV45_(p,user){
  ...
  const comercial={};
  ['precio1','precio2','precio3','precioExtra','costoUnitario','fleteLima','fleteProvincia','producto','um','colorMorado','colorAmarillo','colorRojo','colorAzul','colorVerde'].forEach(function(k){
