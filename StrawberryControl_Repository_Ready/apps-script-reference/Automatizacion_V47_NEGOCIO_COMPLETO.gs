/**
 * STRAWBERRY CONTROL V4.7 - NEGOCIO COMPLETO + SINCRONIZACION RESTAURADA
 * -----------------------------------------------------------------------------
...
function asegurarConfiguracionNegocioV47_(libro, gestion) {
  ...
  hoja.getRange(2, 2, 7, 1).setNumberFormat('0.00');
...
function leerConfiguracionDesdePanelV47_(gestion) {
  ...
  try {
    ...
    return {
      ...
      fleteProvincia: numeroConfig_(v[6], d.fleteProvincia), producto: String(v[7] || d.producto).trim() || d.producto,
...
function guardarConfiguracionNegocioV47_(cambios) {
  ...
  const mapa = {
    ...
    FLETE_PROVINCIA: nueva.fleteProvincia, PRODUCTO: nueva.producto, UM: nueva.um,
